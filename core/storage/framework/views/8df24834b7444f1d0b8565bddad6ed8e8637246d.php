            ...
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-7 col-md-8">
                        <div class="section-title white-color">
                            <h1 class="title">
                                Layanan Bank Bandung
                            </h1>
                            <!-- <h5 class="title"> -->
                                Bank Bandung berkomitmen untuk selalu meningkatkan pelayanan bagi nasabah
                            <!-- </h5> -->
                        </div>
                    </div>
                    <div class="col-auto">
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\bprbandung\core\resources\views/front/themes/theme7.blade.php ENDPATH**/ ?>